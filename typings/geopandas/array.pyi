...
class GeometryArray(ExtensionArray):
    ...
    def x(
        self,
    ):  # -> (object: object, dtype: DTypeLike = ..., *, copy: bool = ..., order: _OrderKACF = ..., subok: bool = ..., ndmin: int = ..., like: ArrayLike = ...) -> ndarray[Unknown, Unknown]:
    ...
    def astype(
        self, dtype, copy=...
    ):  # -> GeometryArray | ABCExtensionArray | ndarray[Unknown, Unknown]:
        """
