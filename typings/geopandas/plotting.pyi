...
def deprecated(new): # -> (*args: Unknown, **kwargs: Unknown) -> None:
...
def plot_series(s, cmap=..., color=..., ax=..., figsize=..., aspect=..., **style_kwds): # -> Axes:
    """
    Plot a GeoSeries.
...
def plot_dataframe(df, column=..., cmap=..., color=..., ax=..., cax=..., categorical=..., legend=..., scheme=..., k=..., vmin=..., vmax=..., markersize=..., figsize=..., legend_kwds=..., categories=..., classification_kwds=..., missing_kwds=..., aspect=..., **style_kwds): # -> Axes:
    """
    Plot a GeoDataFrame.
