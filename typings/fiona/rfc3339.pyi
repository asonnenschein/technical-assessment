...
def parse_time(
    text,
):  # -> tuple[Literal[0], Literal[0], Literal[0], int, int, int, int, float | int | None]:
...
def parse_date(
    text,
):  # -> tuple[int, int, int, Literal[0], Literal[0], Literal[0], Literal[0], None]:
...
def parse_datetime(
    text,
):  # -> tuple[int, int, int, int, int, int, int, float | int | None]:
