...
class LinearRing(LineString):
    ...
    @property
    def __geo_interface__(self): # -> dict[str, str | tuple[Any, ...]]:
        ...
...
class Polygon(BaseGeometry):
    ...
    @property
    def exterior(self): # -> LinearRing | None:
        ...
    
    @property
    def interiors(self): # -> InteriorRingSequence | list[Unknown]:
        ...
    ...
    @property
    def __geo_interface__(self): # -> dict[str, str | tuple[tuple[Any, ...], ...]]:
        ...
...
def geos_linearring_from_py(ob, update_geom=..., update_ndim=...): # -> tuple[Any | Unknown, Unknown] | tuple[Any, Unknown] | tuple[Any, Literal[3, 2]] | None:
    ...

def update_linearring_from_py(geom, ob): # -> None:
    ...

def geos_polygon_from_py(shell, holes=...): # -> tuple[Any | Unknown, int | Unknown] | tuple[Any, Unknown | Literal[3, 2]] | None:
    ...
