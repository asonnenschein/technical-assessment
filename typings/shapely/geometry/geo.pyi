...
def shape(context): # -> Point | MultiPoint | LineString | MultiLineString | Polygon | MultiPolygon | GeometryCollection:
    """
...
def asShape(context): # -> PointAdapter | LineStringAdapter | PolygonAdapter | MultiPointAdapter | MultiLineStringAdapter | MultiPolygonAdapter | GeometryCollection:
    """
