...
class LineString(BaseGeometry):
    ...
    def array_interface(self): # -> dict[str, int | str | tuple[Literal[0]] | Array[c_double]] | Any:
    ...
    def parallel_offset(self, distance, side=..., resolution=..., join_style=..., mitre_limit=...): # -> BaseGeometry:
...
class LineStringAdapter(CachingGeometryProxy, LineString):
    ...
    @property
    def __array_interface__(self): # -> dict[str, int | str | tuple[Literal[0]] | Array[c_double]] | Any:
        """Provide the Numpy array protocol."""
        ...
...
def geos_linestring_from_py(ob, update_geom=..., update_ndim=...): # -> tuple[Any | Unknown, Unknown] | tuple[Any, Unknown] | tuple[Any, Literal[2, 3]] | None:
    ...

def update_linestring_from_py(geom, ob): # -> None:
    ...
