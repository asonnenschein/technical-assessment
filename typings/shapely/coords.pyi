...
class CoordinateSequence:
    ...
    def __iter__(self): # -> Generator[tuple[float, float, float] | tuple[float, float], None, None]:
        ...
    
    def __getitem__(self, key): # -> tuple[float, float, float] | tuple[float, float] | list[Unknown]:
        ...
...
class BoundsOp(Validating):
    ...
    def __call__(self, this): # -> tuple[float, float, float, float]:
        ...
